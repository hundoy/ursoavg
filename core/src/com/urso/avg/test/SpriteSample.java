...
public class SpriteSample extends GdxSample {
	...
	public void create() {		
		...
		atlas = new TextureAtlas(Gdx.files.local("data/graphics/blocks.atlas"));
		background = new Sprite(atlas.findRegion("green"));
		caveman = new Sprite(atlas.findRegion("red"));
		dinosaur = new Sprite(atlas.findRegion("blue"));
		...
		font = new BitmapFont(Gdx.files.local("data/config/fzh32/fzh.fnt"));
